...
<title>Translation workflow | EdgeRIC v0.1 documentation</title>
<meta content="Translation workflow | EdgeRIC v0.1 documentation" property="og:title"/>
<meta content="Translation workflow | EdgeRIC v0.1 documentation" name="twitter:title"/>
...
<div class="mr-1">/</div><span aria-current="page" class="font-medium text-foreground overflow-hidden text-ellipsis whitespace-nowrap">Translation workflow</span>
</nav>
...
<h2>Structure of translation files</h2>
<section id="translation-source-files">
<h3>Translation source files</h3>
...
<h3>Compiled translation files</h3>
...
<h2>Workflow of translations</h2>
...
<div class="highlight-bash notranslate"><div class="highlight"><pre><span></span><code><span id="line-1">prettier<span class="w"> </span>sphinx_book_theme/translations/jsons/&lt;message<span class="w"> </span>name&gt;.json
</span></code></pre></div>
</div>
</li>
...
<ul>
<li><a :data-current="activeSection === '#structure-of-translation-files'" class="reference internal" href="#structure-of-translation-files">Structure of translation files</a><ul>
<li><a :data-current="activeSection === '#translation-source-files'" class="reference internal" href="#translation-source-files">Translation source files</a></li>
<li><a :data-current="activeSection === '#compiled-translation-files'" class="reference internal" href="#compiled-translation-files">Compiled translation files</a></li>
</ul>
</li>
<li><a :data-current="activeSection === '#workflow-of-translations'" class="reference internal" href="#workflow-of-translations">Workflow of translations</a></li>
<li><a :data-current="activeSection === '#to-update-a-translation'" class="reference internal" href="#to-update-a-translation">To update a translation</a></li>
</ul>
</div>
</aside>
</main>
