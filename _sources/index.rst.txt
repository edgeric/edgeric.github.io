   ...
   <div class="publication-grid">
     <div class="publication-card">
       ...
       <div class="publication-buttons">
         ...
         <a href="index.html#demo-edgeric" class="pub-btn pub-btn-demo">Demo</a>
         ...
         <a href="edgeric.html" class="pub-btn pub-btn-tutorial">Tutorial</a>
       </div>
     </div>
     <div class="publication-card">
       ...
       <div class="publication-buttons">
         ...
         <a href="index.html#demo-beamarmor" class="pub-btn pub-btn-demo">Demo</a>
         ...
         <a href="beamarmor.html" class="pub-btn pub-btn-tutorial">Tutorial</a>
       </div>
     </div>
     <div class="publication-card">
       ...
       <div class="publication-buttons">
         ...
         <a href="index.html#our-demos" class="pub-btn pub-btn-demo">Demo</a>
         <a href="tiny-twin.html" class="pub-btn pub-btn-tutorial">Tutorial</a>
       </div>
     </div>
     <div class="publication-card">
       ...
       <div class="publication-buttons">
         ...
         <a href="https://github.com/ucsdwcsng/EdgeRIC_whittleIndex" class="pub-btn pub-btn-code" target="_blank" rel="noopener">Code on GitHub</a>
         <a href="windex.html" class="pub-btn pub-btn-tutorial">Tutorial</a>
       </div>
     </div>
     <div class="publication-card">
       ...
       <div class="publication-buttons">
         ...
         <a href="https://github.com/ucsdwcsng/EdgeRIC-on-5G" class="pub-btn pub-btn-code" target="_blank" rel="noopener">Code on GitHub</a>
         <a href="sparc.html" class="pub-btn pub-btn-tutorial">Tutorial</a>
       </div>
     </div>
   </div>
