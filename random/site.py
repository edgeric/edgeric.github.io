def allocate_rbs(total_rbs, sites_info):
    """
    Allocate RBs to sites based on weight, avoiding bad RBs, and ensuring continuous segments,
    ...
    for i, site in enumerate(sites_info_sorted):
        ...
        if best_segment is not None:
            ...
            allocations[i] = None
            print(f"Warning: Unable to allocate required RBs for site {i} due to RB constraints.")
